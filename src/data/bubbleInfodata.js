export const bubbleInfo = {
  ...
  form1_1_r: {
    title: "Ohje",
    content: "Onko täytettävä tehtävä kokonaan uusi tai jo olemassa oleva?",
  },
  form1_2_r: {
    title: "Ohje",
    content: [
  ...
  form2_1_l: {
    title: "Vinkki",
    content: [
      "Olethan muistanut jakaa ilmoitustasi myös sosiaalisessa mediassa.",
      "- Facebook",
      "- Instagram",
      "- Twitter",
    ],
  ...
  form2_2_r: {
    title: "Ohje",
    content: [
      "Kerro, mitä odotat työnhakijalta",
      "- osaaminen",
      "- työkokemus",
      "- koulutus",
      "- muut vaatimukset",
